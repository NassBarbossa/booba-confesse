...
async function generateFrame(
  ...
  // Character size (75% of video height)
  ...
  // Mouth at 60% of character height, centered
  const mouthX = charX + Math.floor((charSize - mouthWidth) / 2);
  const mouthY = charY + Math.floor(charSize * 0.60) - Math.floor(mouthHeight / 2);
